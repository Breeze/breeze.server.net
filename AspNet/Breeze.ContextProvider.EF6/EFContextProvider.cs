  ...
  public class EFContextProvider<T> : Breeze.ContextProvider.ContextProvider, IEFContextProvider where T : class, new() {
    ...
    protected override Task OpenDbConnectionAsync(CancellationToken cancellationToken) {
      ...
      if (ec.State == ConnectionState.Closed) {
        return ec.OpenAsync(cancellationToken);
      } else {
    ...
    protected override void SaveChangesCore(SaveWorkState saveWorkState) {
      ...
      try {
        ...
        saveWorkState.EntityErrors = MakeEntityErrors(e, saveWorkState);
    ...
    /// <summary> Build EntityErrors from the info in the exception </summary>
    private List<EntityError> MakeEntityErrors(DbEntityValidationException e, SaveWorkState saveWorkState) {
