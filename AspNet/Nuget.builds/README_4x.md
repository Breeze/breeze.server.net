...
- [Breeze.ContextProvider](https://www.nuget.org/packages/Breeze.ContextProvider/)
- [Breeze.ContextProvider.EF6](https://www.nuget.org/packages/Breeze.ContextProvicer.EF6/) (support for EF 6)
- [Breeze.ContextProvider.NH](https://www.nuget.org/packages/Breeze.ContextProvider.NH/) (support for NHibernate)
- [Breeze.WebApi2](https://www.nuget.org/packages/Breeze.WebApi2/)
...
See the [docs](http://breeze.github.io/doc-net/nuget-packages.html) for .NET Core NuGet packages

## Documentation 

See the [docs](http://breeze.github.io/doc-net/) for more info about what Breeze does and how to use it.
...
The recent sources and solutions are in the [breeze.server.net](https://github.com/Breeze/breeze.server.net) repo under the  **AspNet** folder.  Building is just a matter of:
