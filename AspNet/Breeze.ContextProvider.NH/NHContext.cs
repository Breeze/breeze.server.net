...
namespace Breeze.ContextProvider.NH {
  public class NHContext : Breeze.ContextProvider.ContextProvider, IDisposable {
    ...
    protected override bool BeforeSaveEntity (EntityInfo entityInfo, CancellationToken cancellationToken)
    {
        if (!base.BeforeSaveEntity(entityInfo, cancellationToken)) return false;
